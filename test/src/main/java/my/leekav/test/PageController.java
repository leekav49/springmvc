...
import my.leekav.test.domain.MemberDTO;
import my.leekav.test.domain.ReportDTO;
...
//출력할 뷰 이름 설정
	...
	public void getfor(@RequestParam("name") String name, @RequestParam("password") String password, Model model) {
		System.out.println(name);
